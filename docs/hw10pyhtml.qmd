...
the .append adds a data type (character string, integer, bolean variables, etc) onto the end of a list
...
the .remove removes a data type from a list. You explicitly indicate the item you want removed from the list
...
# this gives me the length of my dictionary and how many pairs of values are in it
